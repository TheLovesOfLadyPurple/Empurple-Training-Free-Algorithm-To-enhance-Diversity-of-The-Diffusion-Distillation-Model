...
def main():
    ...
    parser.add_argument("--outdir", type=str, default="./gen_img_val_fetch_latent_val_2014")
    ...
    folder_name = f"samples-turbo-ts{opt.latent_timestep}-step-1"
    if opt.force_org:
        folder_name += "-org"
            ...
            for n in trange(opt.n_iter, desc="Sampling"):
                for prompts in tqdm(grouped, desc="data"):
                    ...
                    if not opt.force_org:
                        ...
                        idx = [random.randint(0, stored_embeds.shape[0] - 1)]#cosine_similarity_match(prompt_embeds, stored_embeds)
