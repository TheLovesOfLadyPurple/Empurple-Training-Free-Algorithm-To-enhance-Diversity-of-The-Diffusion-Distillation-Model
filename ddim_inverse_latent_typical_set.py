...
def main():
    ...
    folder_name = f"samples-{opt.mode}-ts{opt.latent_timestep}-step-{opt.ddim_steps}" + ("-compare_cosine" if opt.compare_cosine_similarity else "-random")
        ...
        with precision_scope("cuda"):
            ...
            for n in trange(opt.n_iter, desc="Sampling"):
                for prompts in tqdm(grouped, desc="data"):
                    ...
                    if opt.compare_cosine_similarity:
