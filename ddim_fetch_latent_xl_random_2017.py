...
def main():
    ...
    parser.add_argument("--outdir", type=str, default="./gen_img_val_fetch_latent_val_2017_xl_hyper_random")
    ...
    parser.add_argument("--use_decode_net_type", type=str, default="Hyper-SD",
            ...
            for n in trange(opt.n_iter, desc="Sampling"):
                for prompts in tqdm(grouped, desc="data"):
                    ...
                    if True:
                        ...
                        idx = [random.randint(0, stored_embeds.shape[0] - 1)]
