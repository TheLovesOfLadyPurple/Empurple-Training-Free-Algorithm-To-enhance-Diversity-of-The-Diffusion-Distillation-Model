...
def main():
    ...
    parser.add_argument("--outdir", type=str, default="./gen_img_val_fetch_latent_val")
    parser.add_argument("--prompt_dir", type=str,
                        default="./gen_img_val_v15_coco2014_unipc_low/prompt-12-5.5")
    ...
    if opt.latent_dir is None:
        base = "./gen_img_val_v15_coco2014_unipc_low"
