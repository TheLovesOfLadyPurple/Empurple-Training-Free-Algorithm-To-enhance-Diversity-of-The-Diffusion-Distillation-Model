    ...
    def model_fn(x, t_continuous):
        ...
        if guidance_type == "uncond":
            ...
            if guidance_scale == 1.0 or unconditional_condition is None:
                ...
                if grather_feature_dict is not None and grather_feature_dict['cfg_xstart'] is not None:
                    x_start_cond = get_x0_from_noise(x, t_continuous, noise)
                    x_start_uncond = get_x0_from_noise(x, t_continuous, noise_uncond)
                    x_start_cfg = x_start_uncond + guidance_scale * (x_start_cond - x_start_uncond)
                    grather_feature_dict['cfg_xstart'].append(x_start_cfg)
