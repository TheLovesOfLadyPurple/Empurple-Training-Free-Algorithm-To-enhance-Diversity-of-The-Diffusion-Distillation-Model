...
def main():
    ...
    parser.add_argument("--outdir", type=str, default="./gen_img_val_fetch_latent_val_2017")
    ...
    parser.add_argument("--force_org", type=bool, default=False)
    ...
    solver = LCMSDESolver(
        ...
        ddim_timesteps=4,
        start_timestep=opt.noise_timestep if not opt.force_org else None,
    )
    ...
    data = [cap['caption'] for cap in captions][:5000]
